...
$x=$_GET['id'];
$result = mysql_query("SELECT * FROM Movie WHERE movie_id='$x'");
...
mysql_select_db("Movie", $con);
$x80=$_GET['id'];
$result80 = mysql_query("SELECT * FROM Movie WHERE movie_id='$x80'");
...
mysql_select_db("Movie", $con);
$x1=$_GET['id'];
$result1 = mysql_query("SELECT * FROM Movie WHERE movie_id='$x1'");
...
mysql_select_db("Movie", $con);
$x3=$_GET['id'];
$result3 = mysql_query("SELECT * FROM Movie WHERE movie_id='$x3'");
...
$x47=$_GET["id"];
mysql_select_db("Movie", $con);
$x90 = mysql_query("SELECT * FROM Movie WHERE movie_id='$x47'"); 
...
mysql_select_db("Movie", $con);
$x2=$_GET['id'];
$result2 = mysql_query("SELECT * FROM Movie WHERE movie_id='$x2'");
...
mysql_select_db("Movie", $con);
$x4=$_GET['id'];
$result4 = mysql_query("SELECT * FROM Movie WHERE movie_id='$x4'");
...
mysql_select_db("Movie", $con);
$x6=$_GET['id'];
$result6 = mysql_query("SELECT * FROM Movie WHERE movie_id='$x6'");
...
mysql_select_db("Movie", $con);
$x30=$_GET['id'];
$result30 = mysql_query("SELECT * FROM Movie WHERE movie_id='$x30'"); // Suggestions php code
...
mysql_select_db("Movie", $con);
$x15=$_GET['id'];
$result15 = mysql_query("SELECT * FROM Review WHERE Id='$x15'");
